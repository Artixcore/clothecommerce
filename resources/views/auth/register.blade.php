            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2>Become Vendor</h2>
                        <span>Sell your Best Designs with us. Fast | Safe | Secure</span>
                    </div>
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <button type="submit" id="form-submit" class="main-dark-button"><i class="fa fa-user-plus" aria-hidden="true"></i></button>
